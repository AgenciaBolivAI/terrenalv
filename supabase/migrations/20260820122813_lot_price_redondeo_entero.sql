...
-- vendedor dice "treinta y seis mil ochocientos setenta y nueve", el cartel
-- dice otra cosa, y el comprador desconfía de la diferencia.
--
...
-- función, así que redondear en un solo lado dejaría los otros con la cifra
