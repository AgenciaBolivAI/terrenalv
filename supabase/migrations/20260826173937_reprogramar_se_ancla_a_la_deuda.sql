-- La versión definitiva de admin_editar_plan. La de «el_plan_cobra_lo_que_se
-- debe» llamaba a una función que no existe (p_plan_id_reserva — plpgsql no
-- valida los cuerpos al crearlos, así que pasó callada); esta es la sana, y
-- por venir después, es la que queda al reconstruir.
...
begin
  ...
  -- El financiado del encabezado sigue al cronograma: capital de las cuotas
  -- vivas más lo ya amortizado en cuotas pagadas de este plan.
