-- v_planes no exponía el interés MENSUAL, que es el que se pacta y el que el
-- cronograma impreso tiene que decirle al comprador. Al final de la lista:
...
select pl.id as plan_id,
       ...
       -- Lo que termina pagando por el financiamiento, y cuánto de eso es
       -- interés: las dos cifras que el comprador pregunta primero.
